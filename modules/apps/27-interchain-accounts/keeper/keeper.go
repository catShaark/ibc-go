...
func (k ExecuteKeeper) AuthenticateTx(ctx sdk.Context, msgs []sdk.Msg, controller string, destChannel string) error {
...
func (k ExecuteKeeper) ExecuteTx(ctx sdk.Context, controller string, destChannel string, msgs []sdk.Msg) error {
	err := k.AuthenticateTx(ctx, msgs, controller, destChannel)
	if err != nil {
		return err
	}
